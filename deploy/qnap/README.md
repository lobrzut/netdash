...
**Od v1.3.94+** safe mode i limity zasobów są domyślne **w całym projekcie NetDash** (każdy deploy, nie tylko QNAP): `NETDASH_SCAN_SAFE_MODE=true`, `mem_limit: 512m`, `cpu_count: 1`. Na słabym sprzęcie użyj węższego CIDR (`/28`).
