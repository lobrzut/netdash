...
[![Version](https://img.shields.io/badge/version-1.3.145-blue)](app/config.py)
...
| `NETDASH_DISCOVERY_ENABLED` | Master switch for background TCP discovery (`false` by default in Dockge compose) |
